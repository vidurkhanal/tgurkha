<footer class="bg-white">
    <div class="text-center bg-gray-200 pt-16 pb-8 ">
      <h2 class="text-3xl font-extrabold text-gray-900 sm:text-3xl">
          Client Centric Approach For Your Unique Business Challenges
      </h2>

      <p class="mx-auto mt-4 max-w-sm text-gray-500">
          Unlocking the Power of Technology to Optimize Your Operations and Boost Revenue"
      </p>
    ...
    <div class="mx-auto max-w-screen-xl px-4 pb-8 sm:px-6 lg:px-8 ">
      ...
      <div
        class="border-t border-gray-100 pt-8 sm:flex sm:items-center sm:justify-between lg:mt-24"
      >
